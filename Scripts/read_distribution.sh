...
# python /home/567/nn8573/miniconda3/pkgs/rseqc-5.0.3-py310h4b81fae_0/bin/
# (Commented line above only needed if calling read_distribution.py directly using minicoda3's python) and not the rseqc module
read_distribution.py -i ${bam} -r ${bed} > ${out} 2>>${logfile}
